  ...
  return (
    <>
      ...
      <div className='w-full flex'>
        ...
        >
          Following projects showcases my skills and knowledge. Through real-world examples
          of my work. Each project is briefly described with links to code repositories and live
          demos in it. It reflects my ability to solve complex problems, work with differents
          technologies and frameworks and manage projects effectively.
        </motion.p>
      </div>
